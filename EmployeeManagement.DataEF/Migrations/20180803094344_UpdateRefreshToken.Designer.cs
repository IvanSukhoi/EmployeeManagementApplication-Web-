...
namespace EmployeeManagement.DataEF.Migrations
{
    ...
    [Migration("20180803094344_UpdateRefreshToken")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmployeeManagement.DataEF.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("EmployeeManagement.DataEF.Entities.Token", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<string>("JsonWebRefreshToken");
            ...
            modelBuilder.Entity("EmployeeManagement.DataEF.Entities.UserRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("EmployeeManagement.DataEF.Entities.UserRole", b =>
                {
                    b.HasOne("EmployeeManagement.DataEF.Entities.Role", "Role")
                        .WithMany("UserRoles")
